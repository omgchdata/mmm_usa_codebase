...
ProjectName <-  "sub_model"            # the name of the sub-folder that contains the model project
OutDir <- "output"
...
d1 <- decomp_summary(mod_obj$Decomposition, mod_obj$SimStart, mod_obj$SimEnd, "search")
d2 <- decomp_summary(mod_obj$Decomposition, mod_obj$SimStart-365, mod_obj$SimEnd-365, "search")
d <- full_join(d1, d2)
#print(d)

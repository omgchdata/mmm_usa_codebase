...
RootDirectory <- "C:/Users/julia.liu/OneDrive - Omnicom Media Group/Documents/MyWork/Projects/Julia/"
...
#n <- names(x)
#n <- gsub(" ", "_", n)    # fix some naming issue in the raw dataset
#names(x) <- n
...
x$disp_olv_imp <- x$BAC_ONLV_IMP + x$BAC_DIS_IMP
